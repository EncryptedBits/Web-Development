...
class P2pChat(tk.Frame):
    tree = ET.parse(str(os.path.dirname(__file__))+'\\'+'\\'+'chat.xml')
    def __init__(self, master=None):
        
        self.root = P2pChat.tree.getroot()
        global DEFAULT_PORT
        self.var=IntVar()
        self.threadname_list=["INFO","GRIEVANCES","REQUEST","FEEDBACK","OTHERS"]
        self.active_threads=[]
    ...
    def thread_display(self):
        ...
        P2pChat.tree = ET.parse(str(os.path.dirname(__file__))+'\\'+'\\'+'chat.xml')
        self.root = P2pChat.tree.getroot()
                ...
                if msg[-1].isdigit():
                    ...
                    if self.is_server:
                        try:
                            ...
                            P2pChat.tree.write(str(os.path.dirname(__file__))+'\\'+'\\'+'chat.xml')
                        except Exception:
                            pass
                else:
